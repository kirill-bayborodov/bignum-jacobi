/**
 * @file test_bignum_jacobi_benchmark_adapter.c
 * @brief Deterministic unit tests for the bignum_jacobi benchmark-core adapter.
 *
 * @details
 ...
 */
typedef enum {
    BIGNUM_JACOBI_ADAPTER_TEST_STATUS_SUCCESS = 0, /**< The test helper's assertions succeeded. */
    BIGNUM_JACOBI_ADAPTER_TEST_STATUS_FAILURE = 1 /**< An observed adapter outcome differed from its contract. */
} bignum_jacobi_adapter_test_status_t;
 ...
 * @return A named bignum_jacobi_adapter_test_status_t result.
 *
 * @details
 ...
 */
static bignum_jacobi_adapter_test_status_t bignum_jacobi_adapter_test_make_workload(
    benchmark_workload_t *workload)
{
    if (workload == NULL) {
        return BIGNUM_JACOBI_ADAPTER_TEST_STATUS_FAILURE;
    }
    *workload = (benchmark_workload_t){
        ...
        .operation_kind = "jacobi-fixed", /**< Evaluate the generated numerator against the fixed odd modulus. */
    ...
    return BIGNUM_JACOBI_ADAPTER_TEST_STATUS_SUCCESS;
}
 ...
 */
static bignum_jacobi_adapter_test_status_t bignum_jacobi_adapter_test_validation(void)
{
    benchmark_workload_t workload;
    benchmark_workload_t invalid_workload;

    if (bignum_jacobi_adapter_test_make_workload(&workload) !=
        BIGNUM_JACOBI_ADAPTER_TEST_STATUS_SUCCESS) {
        return BIGNUM_JACOBI_ADAPTER_TEST_STATUS_FAILURE;
    }
    if (bignum_jacobi_benchmark_validate_workload(&workload) !=
        BIGNUM_JACOBI_BENCHMARK_STATUS_SUCCESS) {
        return BIGNUM_JACOBI_ADAPTER_TEST_STATUS_FAILURE;
    }
    invalid_workload = workload;
    invalid_workload.operation_kind = "xor";
    if (bignum_jacobi_benchmark_validate_workload(&invalid_workload) !=
        BIGNUM_JACOBI_BENCHMARK_STATUS_INVALID_PROFILE) {
        return BIGNUM_JACOBI_ADAPTER_TEST_STATUS_FAILURE;
    }
    if (bignum_jacobi_benchmark_validate_workload(NULL) !=
        BIGNUM_JACOBI_BENCHMARK_STATUS_NULL_ARGUMENT) {
        return BIGNUM_JACOBI_ADAPTER_TEST_STATUS_FAILURE;
    }
    return BIGNUM_JACOBI_ADAPTER_TEST_STATUS_SUCCESS;
}
 ...
 */
static bignum_jacobi_adapter_test_status_t bignum_jacobi_adapter_test_callbacks(void)
{
    ...
    if (bignum_jacobi_benchmark_adapter_init(NULL) !=
        BIGNUM_JACOBI_BENCHMARK_STATUS_NULL_ARGUMENT) {
        return BIGNUM_JACOBI_ADAPTER_TEST_STATUS_FAILURE;
    }
    if (bignum_jacobi_benchmark_adapter_init(&adapter) !=
        BIGNUM_JACOBI_BENCHMARK_STATUS_SUCCESS || adapter.initialize == NULL ||
    ...
    return checksum == 0U
        ? BIGNUM_JACOBI_ADAPTER_TEST_STATUS_FAILURE
        : BIGNUM_JACOBI_ADAPTER_TEST_STATUS_SUCCESS;
}
...
int main(void)
{
    if (bignum_jacobi_adapter_test_validation() !=
        BIGNUM_JACOBI_ADAPTER_TEST_STATUS_SUCCESS) {
        fputs("bignum_jacobi benchmark adapter validation test failed\n", stderr);
        return 1;
    }
    if (bignum_jacobi_adapter_test_callbacks() !=
        BIGNUM_JACOBI_ADAPTER_TEST_STATUS_SUCCESS) {
        fputs("bignum_jacobi benchmark adapter callback test failed\n", stderr);
        return 1;
    }
    puts("bignum_jacobi benchmark adapter tests: OK");
    return 0;
}
